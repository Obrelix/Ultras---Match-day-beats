// ============================================
// beatDetection.js — Spectral Flux + Beat Grid DSP pipeline
// ============================================

import { BEAT_DETECTION } from './config.js';
...
function computeSpectralFlux(buffer) {
...
export function analyzeBeats(buffer) {
    const sampleRate = buffer.sampleRate;
